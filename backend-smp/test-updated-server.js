...
const testUpdatedServer = async () => {
  try {
    ...
    try {
      const response1 = await fetch('https://erpbackend.tarstech.in/api/payments', {
        method: 'POST',
        headers: {
    ...
    try {
      const response2 = await fetch('https://erpbackend.tarstech.in/api/payments', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    try {
      const response3 = await fetch('https://erpbackend.tarstech.in/api/payments', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
