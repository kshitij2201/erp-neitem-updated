    ...
    try {
      ...
      if (userData?.role === "cc") {
        ...
        response = await axios.get(
          "http://erpbackend.tarstech.in/api/faculty/get-cc-class-students",
          {
        ...
        response = await axios.get(
          `http://erpbackend.tarstech.in/api/faculty/students-attendance/department/${encodeURIComponent(
            userDepartment
          )}`,
          {
            headers: { Authorization: `Bearer ${token}` },
