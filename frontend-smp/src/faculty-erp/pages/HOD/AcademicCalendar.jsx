...
const AcademicCalendar = ({ userData }) => {
  ...
  const fetchCalendars = async () => {
    try {
      ...
      const response = await fetch(
        `http://167.172.216.231:4000/api/academic-calendar?${queryParams}`,
        {
          headers: {
  ...
  const fetchSubjects = async () => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/subjects/department/${userData.department}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchFaculty = async () => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/faculty/department/${userData.department}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteCalendar = async (id) => {
    if (window.confirm("Are you sure you want to delete this calendar?")) {
      try {
        const token = localStorage.getItem("authToken");
        const response = await fetch(
          `http://167.172.216.231:4000/api/academic-calendar/${id}`,
          {
            method: "DELETE",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handlePublishCalendar = async (id) => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/academic-calendar/${id}/publish`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
...
const CreateCalendarModal = ({
  ...
  const fetchFacultiesBySubject = async (subjectId) => {
    try {
      ...
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/faculty/subject/${subjectId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://167.172.216.231:4000/api/academic-calendar",
        {
          method: "POST",
          headers: {
...
const CalendarDetailModal = ({ calendar, onClose, onUpdate }) => {
  ...
  const handlePublish = async () => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/academic-calendar/${calendar._id}/publish`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleAddTopic = async () => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/academic-calendar/${calendar._id}/topics`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdateTopic = async (topicId, updates) => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://167.172.216.231:4000/api/academic-calendar/${calendar._id}/topics/${topicId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
