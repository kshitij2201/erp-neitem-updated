...
export default function PrincipalDashboard() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [
          ...
          fetch("http://erpbackend.tarstech.in/api/superadmin/faculties/all", {
            headers,
          }),
          fetch("http://erpbackend.tarstech.in/api/superadmin/students/all", {
            headers,
          }),
          fetch("http://erpbackend.tarstech.in/api/superadmin/departments/all", {
            headers,
          }),
          fetch(
            "http://erpbackend.tarstech.in/api/dashboard/principal-pending-approvals",
            { headers }
          ),
          fetch(
            "http://erpbackend.tarstech.in/api/dashboard/principal-all-timetables",
            {
              headers,
            }
          ),
        ...
        try {
          const todosRes = await fetch(
            "http://erpbackend.tarstech.in/api/dashboard/principal-todos-demo",
            { headers }
          );
  ...
  const handleUpdateTodo = async (id, status) => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `http://erpbackend.tarstech.in/api/dashboard/principal-todos-demo/${id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
