...
const TeachingAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      console.log(`Full URL: http://erpbackend.tarstech.in/api/announcements/teaching_staff${queryParams}`);
      
      const res = await axios.get(
        `http://erpbackend.tarstech.in/api/announcements/teaching_staff${queryParams}`
      );
