  ...
  const fetchSubmittedLeaves = async () => {
    ...
    try {
      ...
      const [regularLeavesResponse, odLeavesResponse] = await Promise.all([
        axios.get(
          `https://backenderp.tarstech.in/api/leave/my-leaves/${employeeId}`,
          {
            headers: {
        ...
        axios.get(
          `https://backenderp.tarstech.in/api/leave/my-od-leaves/${employeeId}`,
          {
            headers: {
              Authorization: `Bearer ${userData.token}`,
            },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://backenderp.tarstech.in/api/leave/odleave/apply",
        formData,
        {
          headers: {
            Authorization: `Bearer ${userData.token}`,
