  ...
  useEffect(() => {
    const fetchTimetable = async () => {
      try {
        ...
        console.log("FetchedTimetable - Token exists:", !!token);
        console.log("FetchedTimetable - User data:", user);
        console.log(
          "FetchedTimetable - Token length:",
        ...
        // Backend API URL
        const apiUrl = `https://erpbackend.tarstech.in/api/timetable?department=${encodeURIComponent(
          user.department
        )}`;
