...
const BorrowerEntry = () => {
  ...
  const fetchAllStudents = async () => {
    try {
      ...
      let response = await fetch("http://erpbackend.tarstech.in/api/students", {
        method: "GET",
        headers: {
      ...
      if (!response.ok) {
        response = await fetch("http://erpbackend.tarstech.in/api/students/all", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
  ...
  const fetchFacultyDetails = async (id) => {
    try {
      const response = await fetch(
        `erpbackend.tarstech.in/api/faculty/faculties?employeeId=${encodeURIComponent(
          id
        )}`,
        {
          method: "GET",
  ...
  const fetchStudentDetails = async (id) => {
    try {
      const response = await fetch(
        `erpbackend.tarstech.in/api/students/students?studentId=${encodeURIComponent(
          id
        )}`,
        {
          method: "GET",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://erpbackend.tarstech.in/api/borrower-entry",
        formData
      );
  ...
  const fetchBorrowerDetails = async (id, type) => {
    try {
      ...
      const response = await axios.get(
        `erpbackend.tarstech.in/api/borrower-entry?id=${id}&type=${type}`
      );
