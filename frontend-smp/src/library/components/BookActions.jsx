    ...
    try {
      ...
      if (type === "faculty") {
        ...
        try {
          ...
          try {
            const response = await axios.get(
              `https://erpbackend.tarstech.in/api/students/enrollment/${encodeURIComponent(
                studentId
              )}`,
              { headers: getAuthHeaders() }
            );
  ...
  const fetchBookDetails = async (accno) => {
    try {
      ...
      try {
        ...
        const response = await axios.get(
          `https://erpbackend.tarstech.in/api/books/by-accno/${accno}`,
          { headers: getAuthHeaders() }
        );
        ...
        try {
          ...
          const response = await axios.get(
            `https://erpbackend.tarstech.in/api/books/${accno}`
          );
          bookData = response.data;
          ...
          try {
            // Try search endpoint
            const response = await axios.get(
              `https://erpbackend.tarstech.in/api/books?search=${accno}`
            );
            const books =
  ...
  const saveNewBook = async () => {
    try {
      ...
      if (response.data) {
        ...
        try {
          await axios.patch(
            `https://erpbackend.tarstech.in/api/books/accno/${formData.ACCNO}`,
            {
              status: "available",
              QUANTITY: 1,
            }
    ...
    try {
      ...
      if (response.data.data.records.length === 0) {
        ...
        if (filters.ACCNO) {
          try {
            await axios.get(
              `https://erpbackend.tarstech.in/api/books/accno/${filters.ACCNO}`
            );
          } catch (err) {
            if (err.response?.status === 404) {
