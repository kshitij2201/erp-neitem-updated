...
export default function StudentDetails() {
    ...
    const fetchStudents = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          "http://erpbackend.tarstech.in/api/students/public",
          {
            params: { 
      ...
      await Promise.all(
        ...
        try {
          ...
          const feeRes = await axios.get(
            `http://erpbackend.tarstech.in/api/fees?stream=${encodeURIComponent(studentStream)}&branch=${encodeURIComponent(branch)}&batch=${encodeURIComponent(studentBatch)}`,
            { headers }
          );
          ...
          const paymentsRes = await axios.get(
            `http://erpbackend.tarstech.in/api/payments/student/${student._id}`,
            { headers }
          );
  ...
  const fetchFinancialSummary = async () => {
    try {
      ...
      const response = await axios.get("http://erpbackend.tarstech.in/api/accounts/financial-summary", { headers });
