...
export default function PaymentHistoryPage() {
  ...
  const fetchPayments = async () => {
    ...
    try {
      ...
      const url = new URL("http://167.172.216.231:4000/api/payments/history");
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch(
        "http://167.172.216.231:4000/api/payments/history",
        { headers }
      );
      if (response.ok) {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const response = await fetch(
        "http://167.172.216.231:4000/api/payments/analytics?period=30",
        { headers }
      );
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await fetch(
        "http://167.172.216.231:4000/api/notifications",
        {
          headers,
        }
      );
      if (response.ok) {
        ...
        const paymentsResponse = await fetch(
          "http://167.172.216.231:4000/api/payments/history?limit=10&sort=latest",
          { headers }
        );
  ...
  const fetchAlerts = async () => {
    try {
      ...
      const response = await fetch(
        "http://167.172.216.231:4000/api/payments/analytics?period=1",
        { headers }
      );
      if (response.ok) {
        const data = await response.json();
