...
const SemesterManager = () => {
  ...
  const handleCreateSemester = async () => {
    ...
    try {
      const res = await axios.post(
        "http://167.172.216.231:4000/api/superadmin/semesters",
        {
  ...
  const handleUpdateSemester = async () => {
    ...
    try {
      const res = await axios.put(
        `http://167.172.216.231:4000/api/superadmin/semesters/${editingSemester._id}`,
        {
  ...
  const handleDeleteSemester = async (semesterId) => {
    ...
    try {
      await axios.delete(
        `http://167.172.216.231:4000/api/superadmin/semesters/${semesterId}`
      );
