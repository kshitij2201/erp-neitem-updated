...
//     try {
//       const res = await axios.get("https://erpbackend.tarstech.in/api/streams", {
...
//     try {
//       const res = await axios.get(`https://erpbackend.tarstech.in/api/superadmin/departments?streamId=${streamId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       await axios.delete(`https://erpbackend.tarstech.in/api/superadmin/departments/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       fetchDepartments(selectedStreamId);
//     } catch (err) {
...
//     try {
//       await axios.put(
//         `https://erpbackend.tarstech.in/api/superadmin/departments/${id}`,
