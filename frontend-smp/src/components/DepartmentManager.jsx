...
//     try {
//       const res = await axios.get("http://142.93.177.150:4000/api/streams", {
...
//     try {
//       const res = await axios.get(`http://142.93.177.150:4000/api/superadmin/departments?streamId=${streamId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       await axios.post(
//         "http://142.93.177.150:4000/api/superadmin/departments",
...
//     try {
//       await axios.delete(`http://142.93.177.150:4000/api/superadmin/departments/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       fetchDepartments(selectedStreamId);
//     } catch (err) {
...
//     try {
//       await axios.put(
//         `http://142.93.177.150:4000/api/superadmin/departments/${id}`,
...
const DepartmentManager = () => {
  ...
  const fetchStreams = async () => {
    try {
      const res = await axios.get(
        "http://142.93.177.150:4000/api/superadmin/streams",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const fetchDepartments = async (streamId) => {
    try {
      const res = await axios.get(
        `http://142.93.177.150:4000/api/superadmin/departments?streamId=${streamId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
