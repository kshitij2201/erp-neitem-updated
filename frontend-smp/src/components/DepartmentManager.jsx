...
//     try {
//       const res = await axios.get("http://localhost:4000/api/streams", {
...
//     try {
//       const res = await axios.get(`http://localhost:4000/api/superadmin/departments?streamId=${streamId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       await axios.delete(`http://localhost:4000/api/superadmin/departments/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       fetchDepartments(selectedStreamId);
//     } catch (err) {
...
//     try {
//       await axios.put(
//         `http://localhost:4000/api/superadmin/departments/${id}`,
